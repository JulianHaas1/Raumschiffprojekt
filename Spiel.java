...
Sonnensystem.addGegnerischesRaumschiff(gegner7);
        ...
        KosmischeNachrichten SeltenerGeg = new KosmischeNachrichten("Alte Krieger, alte Waffen, altes Wissen. Alter Komet am Rand des Sonnensystems.", 8, "geheimeInformation");
        KosmischeNachrichten Volkswissen = new KosmischeNachrichten("Der Name Xenos steht immer wieder in den alten Büchern. Ein Held aller Völker, sagen sie. Halte seinen Namen in Ehren und sie werden dich ehren.", 5, "geheimeInformation");
                ...
                if (eosNova.pruefeKoordinaten(planet.getKoordinaten()[0], planet.getKoordinaten()[1])) {
                    ...
                    if (antwort == 'J' || antwort == 'j') {
                        ...
                        if (planet.hatKosmischeNachricht() != null) {
                            System.out.println("2. Dein Weltenradio empfängt ein in der Umlaufbahn von " + planet.getName() );
                ...
                if (eosNova.pruefeKoordinaten(gegner.getPosX(), gegner.getPosY())) {
                    ...
                    while (!gegner.isDestroyed() && (eosNova.getLebenspunkte() > 0)) {
                        ...
                        if (kampfAntwort == 'A' || kampfAntwort == 'a') {
                            ...
                            System.out.println(Raumschiff.getWaffenstaerke());
                            ...
                            if (!gegner.isDestroyed()) {
                                ...
                                System.out.println("Das Raumschiff " + eosNova.getName() + " wurde von " + gegner.getName() +
                                        " getroffen und hat noch " + eosNova.getLebenspunkte() + " Lebenspunkte.");
                            } else {
                                System.out.println("Du hast das gegnerische Raumschiff zerstört!");
                                eosNova.getKapitaen().levelUp();
                                Raumschiff.Waffenstaerke += 1;
            ...
            if (zuege >= endbossSpawnZeit) {
                ...
                if (eosNova.pruefeKoordinaten(Endboss.getPosX(), Endboss.getPosY())) {
                    ...
                    if (kampfAntwort == 'A' || kampfAntwort == 'a') {
                        ...
                        int schaden = eosNova.getWaffenstaerke();
                        switch (ziel) {
                            case "1":
